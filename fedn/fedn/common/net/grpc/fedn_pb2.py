...
_SIMPLERESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='message', full_name='grpc.SimpleResponse.message', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INSTRUCTCONFIG = _descriptor.Descriptor(
  name='InstructConfig',
  full_name='grpc.InstructConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='round_timeout', full_name='grpc.InstructConfig.round_timeout', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='model_id', full_name='grpc.InstructConfig.model_id', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='rounds', full_name='grpc.InstructConfig.rounds', index=2,
      number=3, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='clients_required', full_name='grpc.InstructConfig.clients_required', index=3,
      number=4, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='clients_requested', full_name='grpc.InstructConfig.clients_requested', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='task', full_name='grpc.InstructConfig.task', index=5,
      number=6, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='validate', full_name='grpc.InstructConfig.validate', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='helper_type', full_name='grpc.InstructConfig.helper_type', index=7,
      number=8, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['InstructConfig'] = _INSTRUCTCONFIG
...
SimpleResponse = _reflection.GeneratedProtocolMessageType('SimpleResponse', (_message.Message,), {
  ...
  '__module__' : 'fedn.common.net.grpc.fedn_pb2'
  # @@protoc_insertion_point(class_scope:grpc.SimpleResponse)
  })
_sym_db.RegisterMessage(SimpleResponse)

InstructConfig = _reflection.GeneratedProtocolMessageType('InstructConfig', (_message.Message,), {
  'DESCRIPTOR' : _INSTRUCTCONFIG,
  '__module__' : 'fedn.common.net.grpc.fedn_pb2'
  # @@protoc_insertion_point(class_scope:grpc.InstructConfig)
  })
_sym_db.RegisterMessage(InstructConfig)
...
_CONTROL = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Instruct',
    full_name='grpc.Control.Instruct',
    index=4,
    containing_service=None,
    input_type=_INSTRUCTCONFIG,
    output_type=_CONTROLRESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  ...
  _descriptor.MethodDescriptor(
    name='Availability',
    full_name='grpc.Control.Availability',
    index=6,
    containing_service=None,
    input_type=_CONTROLREQUEST,
    output_type=_SIMPLERESPONSE,
