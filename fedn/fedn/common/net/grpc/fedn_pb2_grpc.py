...
class ControlStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Instruct = channel.unary_unary(
                '/grpc.Control/Instruct',
                request_serializer=fedn_dot_common_dot_net_dot_grpc_dot_fedn__pb2.InstructConfig.SerializeToString,
                response_deserializer=fedn_dot_common_dot_net_dot_grpc_dot_fedn__pb2.ControlResponse.FromString,
                )
...
def add_ControlServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Instruct': grpc.unary_unary_rpc_method_handler(
                    servicer.Instruct,
                    request_deserializer=fedn_dot_common_dot_net_dot_grpc_dot_fedn__pb2.InstructConfig.FromString,
                    response_serializer=fedn_dot_common_dot_net_dot_grpc_dot_fedn__pb2.ControlResponse.SerializeToString,
            ),
...
class Control(object):
    ...
    def Instruct(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/grpc.Control/Instruct',
            fedn_dot_common_dot_net_dot_grpc_dot_fedn__pb2.InstructConfig.SerializeToString,
            fedn_dot_common_dot_net_dot_grpc_dot_fedn__pb2.ControlResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
